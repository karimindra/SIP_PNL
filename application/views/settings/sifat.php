<div class="container-fluid">
    ...
    <div class="row mt-2">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <button type="button" data-toggle="modal" data-target="#tambahSifat" class="mb-3 btn btn-primary btn-tambah">Tambah Data</button>
                </div>
            </div>
                        ...
                        <tbody>
                            <?php foreach ($sifat as $num => $s) : ?>
                                <tr>
                                    ...
                                    <td><?= $s['sifat']; ?></td>
                                    <td>
                                        <button type="button" data-toggle="modal" data-target="#ubahSifat" data-id="<?= $s['id']; ?>" data-sifat="<?= $s['sifat']; ?>" class=" btn btn-sm btn-warning btn-ubah" id="ubah-sifat">ubah</button>
