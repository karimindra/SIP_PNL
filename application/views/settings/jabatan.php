<div class="container-fluid">
    ...
    <div class="row mt-2">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-sm-8">
                    <button type="button" data-toggle="modal" data-target="#tambahJabatan" class="mb-3 btn btn-primary btn-tambah">Tambah Data</button>
                </div>
            </div>
                        ...
                        <tbody>
                            <?php foreach ($jabatan as $num => $j) : ?>
                                <tr>
                                    ...
                                    <td><?= $j['jabatan']; ?></td>
                                    <td>
                                        <button type="button" data-toggle="modal" data-target="#ubahJabatan" data-id="<?= $j['id']; ?>" data-nama="<?= $j['nama']; ?>" data-jabatan="<?= $j['jabatan']; ?>" class="btn btn-sm btn-warning btn-ubah" id="ubah-jabatan">ubah</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('pengaturan/jabatan_tambah') ?>" method="post" id="formTambahJabatan">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                    <button type="submit" name="tambah-jabatan" class="btn btn-primary">Tambah Data</button>
                </div>
            </form>
        </div>
    </div>
