    ...
    <div class="row">
        <div class="col-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    <img src="<?= base_url('assets/img/profile/') . $user['image']; ?>" alt="profile" class="card-img-top rounded mt-0 mb-3 mx-auto" width="320" height="170">
                    ...
                    <button type="button" data-toggle="modal" data-target="#profileModal" class="btn btn-primary btn-block">Ubah Profile</button>
                </div>
            </div>
        </div>
    </div>
